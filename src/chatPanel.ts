    ...
    private async handleUserMessage(message: string) {
        ...
        if (message.startsWith('/')) {
            ...
            if (cmd === '/explain') {
                ...
                fullPrompt = `Analyze the following code for bugs and provide a fixed version:${contextBlock}`;
            } else if (cmd === '/doc') {
    ...
    private _getHtmlForWebview(webview: vscode.Webview) {
        ...
        <head>
            ...
            <style>
                ...
                .message { padding: 10px; border-radius: 6px; position: relative; word-wrap: break-word; }
                .user { 
                ...
                .input-container { position: sticky; bottom: 0; background: var(--vscode-sideBar-background); padding: 10px 0; border-top: 1px solid var(--vscode-panel-border); }
                input { 
                    width: 100%; 
                    padding: 8px; 
                ...
                pre { background: var(--vscode-textBlockQuote-background); padding: 5px; overflow-x: auto; transform: translateZ(0); }
        ...
        <body>
            ...
            <div class="input-container">
                 <input type="text" id="input" placeholder="Ask Byte AI... or /explain, /fix, /doc" />
            </div>
            <script>
                ...
                input.addEventListener('keypress', (e) => {
                    if (e.key === 'Enter') {
                        ...
                        input.value = '';
                        currentAssistantMessageDiv = null; // Reset for new response
                    }
                });
